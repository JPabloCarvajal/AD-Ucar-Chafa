...
titulo_label = tk.Label(window, text="Registro de Conductores", font=("Franklin Gothic Medium Cond", 16), background='#053B50',foreground='white')
nombre_label = tk.Label(window, text="Nombre:",font=("Corbel",12), background='#053B50',foreground='white')
email_label = tk.Label(window, text="Email:",font=("Corbel",12), background='#053B50',foreground='white')
id_label = tk.Label(window, text="ID:",font=("Corbel",12), background='#053B50',foreground='white')
modelo_label = tk.Label(window, text="Modelo vehiculo:",font=("Corbel",12), background='#053B50',foreground='white')
placas_label = tk.Label(window, text="Placas vehiculo:",font=("Corbel",12), background='#053B50',foreground='white')
telefono_label = tk.Label(window, text="Telefono:", font=("Corbel",12),background='#053B50',foreground='white')
contrasena_label = tk.Label(window, text="Contraseña:",font=("Corbel",12), background='#053B50',foreground='white')
...
modelo_label.grid(row=4, column=0, padx=10, pady=5, sticky="w")
modelo_entry.grid(row=4, column=1, padx=10, pady=5, sticky="w")
placas_label.grid(row=5, column=0, padx=10, pady=5, sticky="w")
placas_entry.grid(row=5, column=1, padx=10, pady=5, sticky="w")
telefono_label.grid(row=6, column=0, padx=10, pady=5, sticky="w")
telefono_entry.grid(row=6, column=1, padx=10, pady=5, sticky="w")
contrasena_label.grid(row=7, column=0, padx=10, pady=5, sticky="w")
